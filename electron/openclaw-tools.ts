...
export interface ToolDefinition {
  ...
  confirmRequired: boolean  // Some operations need user confirmation
  handlerRef: string        // Reference to the handler function
}

export const DBHT_OPENCLAW_TOOLS: ToolDefinition[] = [
  {
    name: 'dbht_commit',
...
export function getToolsManifest(): {
  ...
  return {
    version: '1.0.0',
    tools: DBHT_OPENCLAW_TOOLS.map(t => ({
      name: t.name,
